...
def main ():
    """
    Write the main function and any other functions that you think are necessary for your
    program to generate and print six sentences with these characteristics:
    ...
    print(f"{get_determiner(0).capitalize()} {get_noun(0)} {get_verb(0,1)} {get_prepositional_phrase(0)}.")
    print(f"{get_determiner(1).capitalize()} {get_noun(1)} {get_verb(1,2)} {get_prepositional_phrase(1)}.")
    print(f"{get_determiner(0).capitalize()} {get_noun(0)} {get_verb(0,2)} {get_prepositional_phrase(0)}.")
    print(f"{get_determiner(1).capitalize()} {get_noun(1)} {get_verb(1,3)} {get_prepositional_phrase(1)}.")
    print(f"{get_determiner(0).capitalize()} {get_noun(0)} {get_verb(0,3)} {get_prepositional_phrase(0)}.")
