...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    """
    total = 0
    for symbol, quanity in symbol_quantity_list:
        name, mass = periodic_table[symbol]
        total += mass * quanity
...
"""
    for i in symbol_quantity_list:
        ...
        quan = symbol_quantity_list[1]
        if symbol in periodic_table:
"""
""" new_quan = quan * ******************************* step 3 ************************************************"""
...
def main():
    ...
    user_chem = input("Please enter a chemical formula. (C13H16N2O2): ")
    # Get a mass in grams from the user.
    user_mass = input("Please enter the mass in grams: ")
    ...
    quan_list = parse_formula(user_chem.upper(), p_table)
    ...
    print(f"Molar mass: {compute_molar_mass(quan_list, p_table):.5f}")
    # Print the number of moles.
    print(f"Number of moles: {float(user_mass)/float(compute_molar_mass(quan_list, p_table)):.5f}")
